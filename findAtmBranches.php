...
?>
    <script type="text/javascript">
        function showDistricts(state, name) {
            ...
            ajaxreq.open('GET', "http://localhost/projects/BankingNew/includes/sendDistricts.php?selectvalue=" + state +"&type="+name, 'true');
            ajaxreq.send();
        ...
        function displayBranches() {
            ...
            ajaxreq.open('GET', "http://localhost/projects/BankingNew/INCLUDES/displayBranches.php?district=" + district, 'true');
            ajaxreq.send();
            ajaxreq.onreadystatechange = function () {
                if (ajaxreq.readyState == 4 && ajaxreq.status == 200) {
        ...
        function displayAtms() {
            ...
            ajaxreq.open('GET', "http://localhost/projects/BankingNew/INCLUDES/displayAtms.php?district=" + district, 'true');
            ajaxreq.send();
            ajaxreq.onreadystatechange = function () {
                if (ajaxreq.readyState == 4 && ajaxreq.status == 200) {
                    document.getElementById("displaybranchesnAtms").innerHTML = ajaxreq.responseText;
